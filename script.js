...
const translations = {
  en: {
    ...
    about_desc: "Barakah Welding has been running since 2012 as a dedicated family business. With over 10 years of hands-on experience, we're committed to delivering neat, long-lasting welding and metal fabrication work. Based in Jalan Haji Baie, Sungai Buloh, Selangor, we're proud to be the trusted choice for residential, commercial, and industrial projects.",
    title_vision: "Our Vision",
    vision: "To become a trusted leader in welding and metal fabrication services, delivering innovative, durable, and high-quality solutions that add long-term value for our customers.",
    title_mision: "Our Mission",
    mission1: "Deliver clean, safe, and professional welding services.",
    mission2: "Provide cost-effective fabrication solutions within agreed timelines.",
    mission3:"Build long-term customer relationships based on trust and satisfaction.",
    mission4:"Continuously enhance skills, technology, and workmanship to meet industry standards.",
    mission5:"Ensure every project site is left clean and well-organized after completion.",
  ...
  ms: {
    ...
    about_desc: "Barakah Welding telah beroperasi sejak tahun 2012 sebagai sebuah perniagaan keluarga yang berdedikasi. Dengan pengalaman lebih 10 tahun, kami komited menyediakan kerja kimpalan dan fabrikasi logam yang kemas serta tahan lama. Berpusat di Jalan Haji Baie, Sungai Buloh, Selangor, kami berbangga menjadi pilihan pelanggan untuk projek kediaman, komersial dan industri.",
    title_vision: "Visi Kami",
    vision: "Menjadi peneraju dipercayai dalam perkhidmatan welding dan fabrikasi besi, menyediakan penyelesaian inovatif, tahan lama dan berkualiti tinggi yang memberi nilai jangka panjang kepada pelanggan.",
    title_mision: "Misi Kami",
    mission1: "Memberikan perkhidmatan welding yang bersih, selamat dan profesional.",
    mission2: "Menyediakan penyelesaian fabrikasi yang menjimatkan kos dalam tempoh masa yang dipersetujui.",
    mission3: "Membina hubungan jangka panjang dengan pelanggan berasaskan kepercayaan dan kepuasan.",
    mission4: "Sentiasa meningkatkan kemahiran, teknologi dan mutu kerja mengikut piawaian industri.",
    mission5: "Memastikan setiap tapak projek ditinggalkan dalam keadaan bersih dan teratur selepas siap.",
  ...
  zh: {
    ...
    hero_contact: "联系我们",
    about_title: "关于我们",
    about_desc: "自2012年以来，Barakah Welding 一直是一家用心经营的家庭企业。凭着超过10年的经验，我们专注于提供精致耐用的焊接和金属加工服务。公司位于雪兰莪双溪毛糯的 Jalan Haji Baie，很荣幸成为住宅、商业和工业项目的首选。",
    title_vision: "我们的愿景",
    vision: "成为值得信赖的焊接和金属制造服务领导者，提供创新、耐用和高质量的解决方案，为客户创造长期价值。",
    title_mision: "我们的使命",
    mission1: "提供干净、安全、专业的焊接服务。",
    mission2: "在约定时间内提供具成本效益的制造方案。",
    mission3: "与客户建立基于信任和满意的长期关系。",
    mission4: "不断提升技能、技术和工艺，以符合行业标准。",
    mission5: "确保每个项目完成后现场保持干净整齐。",
  ...
  ta: {
    ...
    about_desc: "2012 முதல், Barakah Welding ஒரு குடும்ப வணிகமாக நம்பிக்கையுடன் செயல்பட்டு வருகிறது. 10 வருடங்களுக்கு மேற்பட்ட அனுபவத்துடன், நாங்கள் சுத்தமாகவும் நீடித்தும் இருக்கும் வெல்டிங் மற்றும் மெட்டல் ஃபேப்ரிகேஷன் பணிகளை வழங்க உறுதியாக இருக்கிறோம். ஜாலான் ஹாஜி பாய், சுங்கை புலோ, செலாங்கூரில் அமைந்துள்ள எங்கள் நிறுவனம், வீட்டு, வர்த்தக மற்றும் தொழில்துறை திட்டங்களுக்கு நம்பகமான தேர்வாக இருப்பதில் பெருமை கொள்கிறது.",
    title_vision: "எங்கள் பார்வை",
    vision: "வாடிக்கையாளர்களுக்கு நீண்டகால மதிப்பை வழங்கும், புதுமையான, நீடித்த மற்றும் உயர்தரத் தீர்வுகளை வழங்கும், நம்பகமான வெல்டிங் மற்றும் உலோக தயாரிப்பு சேவைகளில் முன்னணி நிறுவனமாக மாறுவது.",
    title_mision: "எங்கள் பணி",
    mission1: "சுத்தமான, பாதுகாப்பான மற்றும் தொழில்முறை வெல்டிங் சேவைகளை வழங்குதல்.",
    mission2: "ஒப்புக்கொள்ளப்பட்ட நேரத்திற்குள் செலவு குறைந்த தயாரிப்பு தீர்வுகளை வழங்குதல்.",
    mission3: "நம்பிக்கை மற்றும் திருப்தியை அடிப்படையாகக் கொண்ட நீண்டகால வாடிக்கையாளர் உறவுகளை உருவாக்குதல்.",
    mission4: "தொழில்நுட்பம், திறன்கள் மற்றும் கைவினைப் பணிகளை தொடர்ந்து மேம்படுத்தி தொழில் தரநிலைகளை பூர்த்தி செய்தல்.",
    mission5: "ஒவ்வொரு திட்டமும் முடிந்த பின் தளத்தை சுத்தமாகவும் ஒழுங்காகவும் வைத்திருப்பதை உறுதிப்படுத்துதல்.",
...
function setLanguage(lang) {
  ...
  // Update semua text yang ada data-translate
  document.querySelectorAll("[data-translate]").forEach(el => {
    const key = el.getAttribute("data-translate");
    if (dict[key]) {
      el.textContent = dict[key];
  ...
  // ✅ Update Vision
  if (dict.vision_title) {
    document.querySelector(".vm-box.vision h3").textContent = dict.vision_title;
    document.querySelector(".vm-box.vision p").textContent = dict.vision_text;
  }

  // ✅ Update Mission
  if (dict.mission_title) {
    document.querySelector(".vm-box.mission h3").textContent = dict.mission_title;
    const missionList = document.querySelector(".vm-box.mission ul");
    missionList.innerHTML = "";
    dict.mission_list.forEach(item => {
